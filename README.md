...
*Note at this point in the lab, it was found out that one of the components, yarGen, doesn't function becuase the website certificate expired right before starting this lab. Had to end here.*
